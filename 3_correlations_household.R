...
tiff("analysis/out/tiff/private_word_networks_singleparents_en.tiff", res = 350, units="in", width=5, height=5)
...
tiff("analysis/out/tiff/private_word_networks_couple_en.tiff", res = 350, units="in", width=5, height=5)
...
tiff("analysis/out/tiff/private_word_networks_alone_en.tiff", res = 350, units="in", width=5, height=5)
plot(networkalone)
# dev.copy(png,"analysis/out/private_word_networks_alone_en.png")
dev.off()

# pdf("analysis/out/private_word_networks_nokids_en.pdf")
tiff("analysis/out/tiff/private_word_networks_nokids_en.tiff", res = 350, units="in", width=5, height=5)
